...
namespace ShaderVariantCollector {
    ...
    public static class ShaderVariantConst
    {
        public const string PluginRootPath = "Assets/ShaderVariantCollector/";

        public const string CacheDataFilePath = PluginRootPath + "Cache/ShaderVariantValidationCache.json";

        public const string TempShaderVarientFilePath = PluginRootPath + "Cache/__temp_VariantCollection.shadervariants";
        ...
        public const string RealtimeScenePath = PluginRootPath + "Developement/LightEnvs/realtime.unity";

        public static string[] LightEnvPathList = new string[] {
                RealtimeScenePath,
                PluginRootPath + "Developement/LightEnvs/subtractive.unity",
                PluginRootPath + "Developement/LightEnvs/shadowmask.unity",
                PluginRootPath + "/Developement/LightEnvs/shadowmask_directional.unity"
        };
    }
